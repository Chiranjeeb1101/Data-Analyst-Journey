...
- **File Handling & APIs**: Ingesting JSON, CSV, Excel, interacting with REST APIs.
- **Automation**: Automating repetitive data transformations and analytical report runs.
